...
SYSTEM_PROMPT = (
    ...
    "   - When 'photo_reference' is set, also try to localize the damage within that specific photo as 'bounding_box': top/left/width/height as percentages (0-100) of that photo's dimensions, measured from the top-left corner, tightly around the visible damage (not the whole part or the whole vehicle). Only set this when you can actually see the damage clearly enough to place a box around it with real confidence -- leave it null rather than a rough or centered guess.\n"
